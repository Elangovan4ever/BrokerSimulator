/**
 * Broker Simulator Polygon API Client
 * Mirrors the real Polygon API for comparison testing
 */
...
export class SimulatorClient {
  ...
  constructor(config: SimulatorClientConfig) {
    ...
    if (config.sessionId) {
      ...
      this.client.defaults.headers['X-Session-ID'] = config.sessionId;
    }
  }
